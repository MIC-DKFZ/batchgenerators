...
if __name__ == "__main__":
    ...
    data_slice_0 = np.array(np.meshgrid(range(100), range(100))).sum(0)
    ...
    batch_gen = MyEasyBatchGenerator((data, target), BATCH_SIZE=10, num_batches=number_of_batches/num_threads, seed=None)
